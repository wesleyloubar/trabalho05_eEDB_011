...
PATH_RAW = 's3://ingestao044/raw/reclamacao/'
PATH_TRUSTED = 's3://ingestao044/trusted/reclamacao/'
...
TABLE_MYSQL = 'db_ingestao04.file_csv_trusted3'
write_mysql(df,TABLE_MYSQL)
print('rodei file_csv_trusted3')
